...
class Alert {
  alertInfo({required context, required text, required text2}) {
    return showDialog(
      context: context,
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  "$text2",
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: global.getWidth(context) / 30),
                ),
              ),
            ],
          ),
  ...
  alertConfirmBack({required context, required message, required onBack}) {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
